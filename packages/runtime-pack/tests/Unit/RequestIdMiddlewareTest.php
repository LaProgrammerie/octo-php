...
final class RequestIdMiddlewareTest extends TestCase
{
    ...
    public function testNoHeaderGeneratesUuidV4(): void
    {
        ...
        self::assertMatchesRegularExpression(self::UUID_V4_PATTERN, $result);
        self::assertSame(36, mb_strlen($result));
    }
    ...
    public function testValidHeaderIsReusedAsIs(): void
    {
        ...
        self::assertSame('my-custom-request-id-123', $result);
    }
    ...
    public function testHeaderTooLongLogsWarning(): void
    {
        ...
        self::assertStringContainsString('X-Request-Id rejected', $logs[0]['message']);
    }
    ...
    public function testEmptyHeaderDoesNotLogWarning(): void
    {
        ...
        $output = mb_trim($this->readLogOutput());
        self::assertSame('', $output, 'Empty header should silently generate a new ID without warning');
    }
    ...
    public function testGeneratedUuidsAreUnique(): void
    {
        ...
        self::assertCount(50, array_unique($uuids), 'Generated UUIDs should be unique');
    }
    ...
    public function testResolveNeverReturnsEmptyString(): void
    {
        ...
        // No header
        self::assertNotSame('', $middleware->resolve($this->createRequest()));

        // Empty header
        self::assertNotSame('', $middleware->resolve($this->createRequest(['x-request-id' => ''])));

        // Invalid header
        self::assertNotSame('', $middleware->resolve($this->createRequest(['x-request-id' => str_repeat('x', 200)])));

        // Valid header
        self::assertNotSame('', $middleware->resolve($this->createRequest(['x-request-id' => 'valid-id'])));
    }
    ...
    public function testWarningLogDoesNotContainRawInput(): void
    {
        ...
        self::assertStringNotContainsString('alert', $output);
        self::assertStringNotContainsString($maliciousInput, $output);
    }
    ...
    public function testWarningLogDoesNotContainNonAsciiRawInput(): void
    {
        ...
        $output = $this->readLogOutput();
        self::assertStringNotContainsString("\xFF", $output);
        self::assertStringNotContainsString('malicious', $output);
    }
    ...
    public function testHeaderWithSpaceIsValid(): void
    {
        ...
        self::assertSame('request id with spaces', $result);
    }
    ...
    public function testHeaderWithTildeIsValid(): void
    {
        ...
        self::assertSame('id~with~tildes', $result);
    }
